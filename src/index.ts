...
export type { Stage, StageStatus, StageLog, GoldenThreadChain } from './core/golden-thread-store.js';
...
export { linkGitHubStage } from './core/golden-thread-github.js';
export type { GitHubStageOptions } from './core/golden-thread-github.js';
